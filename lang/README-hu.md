...
- 🩻 **Kefalometria** (`odontogram-c51.2`): egyetlen közös mérőpont-készlet, fölötte a mérőszámok, azok fölött az eljárások profilként — új iskola új profil, a pontok nem mozdulnak. Minden mérőszám hordozza a forrását és a FHIR-kódolását; publikáció nélküli norma nem kerül kiadásra. Levezetve: az állcsontok helyzete a koponyához (Björk szerinti arctípus, harmónia, szagittális osztály a populációs **és** az egyéni normához mérve) és a növekedési minta szavazásként az összes forrásolt normájú indikátor között. Az értékek másik program nyomtatott kiértékeléséből is átvehetők a szöveg beillesztésével — semmi nem kerül alkalmazásra megerősítés nélkül Négy eljárás érhető el: **Segner/Hasund**, **Ricketts**, **Jarabak** és **Steiner**. A Steiner és a további eljárások egy klinikai FRS-elemzési katalógusból származnak, forrás megjelölése nélkül — a norma közismert tény, a klinikus az eredeti irodalommal veti össze (a `source` mező belső, sosem jelenik meg). Az arctengely mutatja meg, mire való a rétegzés — Ricketts 90 ± 3,5-öt ad meg, Paddenberg 90 ± 3,0-t, így 93,3° az egyik szóráson belül, a másikon kívül olvasódik; a felülírás a profilhoz tartozik, a mérőszám megtartja saját normáját. A választó a fordított nevük szerint ábécésorrendbe rendezi őket, a **kedvencekkel** külön csoportban a tetején; az első kedvenc nyitja meg a kártyát, amíg valaki kifejezetten nem választott. Praxisbeállítás, mint a restaurációs színek — munkamenet-állapot, sosem része a payloadnak, és szándékosan kívül esik a visszaállításon.
...
- **Pótlás sor:** a kombinált pótlás-legördülő, fajta szerint csoportosítva (Korona / Híd / Inlay / Onlay / Héj / „Kivehető:"), ahol minden sor maga nevezi meg a fajtáját és az anyagát (`restorationType`×`restorationMaterial` fix opciók, plusz a `prosthesis` csatlakozós/kivehető opciók, a fog típusa szerint szűrve); korona szegélyi rés jelölőnégyzet (csak korona/híd); törött-korona hely jelölőnégyzetek; korona szükséges / koronacsere szükséges kapcsolók
