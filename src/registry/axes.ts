...
export const AXES: ClinicalAxis[] = [
  ...
  { id: "rootFracture", field: "rootFracture", kind: "enum", valueGroup: "rootFracture",
    ...
    uiOptions: [
      { value: "none", labelKey: "rootFracture.option.none" },
      { value: "vertical", labelKey: "rootFracture.option.vertical" },
      { value: "horizontal", labelKey: "rootFracture.option.horizontal" },
    ] },
  { id: "rootResection", field: "rootResection", kind: "enum", valueGroup: "rootResection",
    skipValue: "none", finding: { local: "root-resective-surgery", display: "Root resective surgery" },
    values: valuesFrom("rootResection"),
    uiOptions: [
      { value: "none", labelKey: "rootResection.option.none" },
      { value: "hemisection", labelKey: "rootResection.option.hemisection" },
      { value: "amputation", labelKey: "rootResection.option.amputation" },
      { value: "premolarisation", labelKey: "rootResection.option.premolarisation" },
    ] },
