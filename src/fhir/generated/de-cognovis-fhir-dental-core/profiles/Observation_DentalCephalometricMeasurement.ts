...
export type DentalCephalometricMeasurementProfileRaw = {
...
// CanonicalURL: https://fhir.cognovis.de/dental-core/StructureDefinition/dental-cephalometric-measurement (pkg: de.cognovis.fhir.dental.core#0.3.0)
export class DentalCephalometricMeasurementProfile {
    static readonly canonicalUrl = "https://fhir.cognovis.de/dental-core/StructureDefinition/dental-cephalometric-measurement";
    ...
    static from (resource: Observation) : DentalCephalometricMeasurementProfile {
        if (!resource.meta?.profile?.includes(DentalCephalometricMeasurementProfile.canonicalUrl)) {
            throw new Error(`DentalCephalometricMeasurementProfile: meta.profile must include ${DentalCephalometricMeasurementProfile.canonicalUrl}`)
        }
        const profile = new DentalCephalometricMeasurementProfile(resource);
    ...
    static is (resource: unknown) : resource is Observation {
        ...
        return (r.meta?.profile ?? []).includes(DentalCephalometricMeasurementProfile.canonicalUrl);
    }

    static apply (resource: Observation) : DentalCephalometricMeasurementProfile {
        ensureProfile(resource, DentalCephalometricMeasurementProfile.canonicalUrl);
        return new DentalCephalometricMeasurementProfile(resource);
    }

    static createResource (args: DentalCephalometricMeasurementProfileRaw) : Observation {
        const resource: Observation = {
            ...
            meta: { profile: [DentalCephalometricMeasurementProfile.canonicalUrl] },
        }
        return resource;
    }

    static create (args: DentalCephalometricMeasurementProfileRaw) : DentalCephalometricMeasurementProfile {
        const resource = DentalCephalometricMeasurementProfile.createResource(args);
        return DentalCephalometricMeasurementProfile.apply(resource);
    }
    ...
    validate(): { errors: string[]; warnings: string[] } {
        const profileName = "DentalCephalometricMeasurement"
