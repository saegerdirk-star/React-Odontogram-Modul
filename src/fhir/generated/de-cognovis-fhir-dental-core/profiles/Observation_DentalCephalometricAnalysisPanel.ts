...
// CanonicalURL: https://fhir.cognovis.de/dental-core/StructureDefinition/dental-cephalometric-analysis-panel (pkg: de.cognovis.fhir.dental.core#0.7.1)
export class DentalCephalometricAnalysisPanelProfile {
    ...
    static from (resource: Observation) : DentalCephalometricAnalysisPanelProfile {
        if (!resource.meta?.profile?.includes(DentalCephalometricAnalysisPanelProfile.canonicalUrl)) {
            throw new Error(`DentalCephalometricAnalysisPanelProfile: meta.profile must include ${DentalCephalometricAnalysisPanelProfile.canonicalUrl}`)
        }
        const profile = new DentalCephalometricAnalysisPanelProfile(resource);
    ...
    static is (resource: unknown) : resource is Observation {
        ...
        return (r.meta?.profile ?? []).includes(DentalCephalometricAnalysisPanelProfile.canonicalUrl);
    }

    static apply (resource: Observation) : DentalCephalometricAnalysisPanelProfile {
        ensureProfile(resource, DentalCephalometricAnalysisPanelProfile.canonicalUrl);
        return new DentalCephalometricAnalysisPanelProfile(resource);
    }

    static createResource (args: DentalCephalometricAnalysisPanelProfileRaw) : Observation {
        const resource: Observation = {
            ...
            meta: { profile: [DentalCephalometricAnalysisPanelProfile.canonicalUrl] },
        }
        return resource;
    }

    static create (args: DentalCephalometricAnalysisPanelProfileRaw) : DentalCephalometricAnalysisPanelProfile {
        const resource = DentalCephalometricAnalysisPanelProfile.createResource(args);
        return DentalCephalometricAnalysisPanelProfile.apply(resource);
    }
    ...
    validate(): { errors: string[]; warnings: string[] } {
        const profileName = "DentalCephalometricAnalysisPanel"
