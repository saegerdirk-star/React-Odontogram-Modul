...
export type DentalPhotostaticAnalysisProfileRaw = {
...
// CanonicalURL: https://fhir.cognovis.de/dental-core/StructureDefinition/dental-photostatic-analysis (pkg: de.cognovis.fhir.dental.core#0.6.0)
export class DentalPhotostaticAnalysisProfile {
    static readonly canonicalUrl = "https://fhir.cognovis.de/dental-core/StructureDefinition/dental-photostatic-analysis";
    ...
    static from (resource: Observation) : DentalPhotostaticAnalysisProfile {
        if (!resource.meta?.profile?.includes(DentalPhotostaticAnalysisProfile.canonicalUrl)) {
            throw new Error(`DentalPhotostaticAnalysisProfile: meta.profile must include ${DentalPhotostaticAnalysisProfile.canonicalUrl}`)
        }
        const profile = new DentalPhotostaticAnalysisProfile(resource);
    ...
    static is (resource: unknown) : resource is Observation {
        ...
        return (r.meta?.profile ?? []).includes(DentalPhotostaticAnalysisProfile.canonicalUrl);
    }

    static apply (resource: Observation) : DentalPhotostaticAnalysisProfile {
        ensureProfile(resource, DentalPhotostaticAnalysisProfile.canonicalUrl);
        return new DentalPhotostaticAnalysisProfile(resource);
    }

    static createResource (args: DentalPhotostaticAnalysisProfileRaw) : Observation {
        const resource: Observation = {
            ...
            meta: { profile: [DentalPhotostaticAnalysisProfile.canonicalUrl] },
        }
        return resource;
    }

    static create (args: DentalPhotostaticAnalysisProfileRaw) : DentalPhotostaticAnalysisProfile {
        const resource = DentalPhotostaticAnalysisProfile.createResource(args);
        return DentalPhotostaticAnalysisProfile.apply(resource);
    }
    ...
    validate(): { errors: string[]; warnings: string[] } {
        const profileName = "DentalPhotostaticAnalysis"
