...
export interface RequestGroupAction extends BackboneElement {
    ...
    resource?: Reference<string /* Resource */>;
...
// CanonicalURL: http://hl7.org/fhir/StructureDefinition/RequestGroup (pkg: hl7.fhir.r4.core#4.0.1)
export interface RequestGroup extends DomainResource {
    ...
    replaces?: Reference<string /* Resource */>[];
