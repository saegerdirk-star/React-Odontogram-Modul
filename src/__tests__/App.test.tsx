...
// Partially mock odontogram.ts: its imperative entry points manipulate real DOM
// and SVGs, so every one of them is stubbed below. Importing the module itself
// is harmless, so the rest is spread through from the original.
