...
// (odontogram.ts's imperative entry points manipulate real DOM/SVGs and are
// stubbed out) since nothing here needs a live `initOdontogram()`/SVG-grid mount.
import { describe, it, expect, vi, beforeEach } from 'vitest';
import { render, cleanup } from '@testing-library/react';
import App from '../App';

// Partial mock, same harness as App.test.tsx: the imperative DOM/SVG entry
// points are stubbed, everything else comes from the original module.
